...
const Data = () => {
    ...
    React.useEffect(() => {
        const typed = new Typed(el.current, {
            strings: ['Undergraduate', 'Training Full-stack Developer', 'Front-end Developer', 'Content Creator', 'Photographer', 'Videographer', 'Social Media Manager'],
            typeSpeed: 50,
            backSpeed: 50,
            loop: true,
            showCursor: false,
    ...
    return (
        <div className="home__data">
            <h2 className="home__welcome">Hi, I am</h2>
            <h1 className="home__title">Methmika Perera
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home__description">I am an Undergraduate of Java Institute for Advanced Technology studying Bsc.(Hons) Software Enginnering Degree offering from Birmingham City University, UK.</p>
